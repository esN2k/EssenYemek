...
class _GirisWidgetState extends State<GirisWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Giris'});
    if (!isWeb) {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'GIRIS_PAGE_Row_4ukbm94e_ON_TAP');
                                logFirebaseEvent('Row_navigate_to');

                                context.pushNamed('SifreUnuttum');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'GIRIS_PAGE_HESAP_OLUTUR_BTN_ON_TAP');
                                  logFirebaseEvent('Button_navigate_to');

                                  context.pushNamed('Onboarding_HesapOlustur');
                                },
                                text: FFLocalizations.of(context).getText(
