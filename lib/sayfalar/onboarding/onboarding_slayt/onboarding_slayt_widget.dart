...
import 'onboarding_slayt_model.dart';
export 'onboarding_slayt_model.dart';

class OnboardingSlaytWidget extends StatefulWidget {
  const OnboardingSlaytWidget({super.key});

  @override
  State<OnboardingSlaytWidget> createState() => _OnboardingSlaytWidgetState();
}

class _OnboardingSlaytWidgetState extends State<OnboardingSlaytWidget>
    with TickerProviderStateMixin {
  late OnboardingSlaytModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingSlaytModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Onboarding_Slayt'});
                      ...
                      children: [
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ONBOARDING_SLAYT_DEVAM_ET_BTN_ON_TAP');
