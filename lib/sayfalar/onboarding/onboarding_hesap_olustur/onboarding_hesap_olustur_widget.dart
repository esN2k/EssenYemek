...
import 'onboarding_hesap_olustur_model.dart';
export 'onboarding_hesap_olustur_model.dart';

class OnboardingHesapOlusturWidget extends StatefulWidget {
  const OnboardingHesapOlusturWidget({super.key});

  @override
  State<OnboardingHesapOlusturWidget> createState() =>
      _OnboardingHesapOlusturWidgetState();
}

class _OnboardingHesapOlusturWidgetState
    extends State<OnboardingHesapOlusturWidget> {
  late OnboardingHesapOlusturModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingHesapOlusturModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Onboarding_HesapOlustur'});
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ONBOARDING_HESAP_OLUSTUR_HESAP_OLUTUR_BT');
                            ...
                            context.goNamedAuth('Panel', context.mounted);
                          },
